    ...
    <div className="flex items-center justify-center min-h-screen bg-[#030712] relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-white">Join Trackify</h2>
          <p className="mt-2 text-sm text-slate-400">Start your journey to peak productivity.</p>
        </div>
